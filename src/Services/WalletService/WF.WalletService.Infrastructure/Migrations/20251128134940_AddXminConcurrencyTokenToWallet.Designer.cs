...
namespace WF.WalletService.Infrastructure.Migrations
{
    ...
    [Migration("20251128134940_AddXminConcurrencyTokenToWallet")]
    partial class AddXminConcurrencyTokenToWallet
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WF.WalletService.Domain.Entities.Wallet", b =>
                {
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "AvailableBalance", "WF.WalletService.Domain.Entities.Wallet.AvailableBalance#Money", b1 =>
                        {
                            b1.IsRequired();
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "Balance", "WF.WalletService.Domain.Entities.Wallet.Balance#Money", b1 =>
                        {
                            b1.IsRequired();
